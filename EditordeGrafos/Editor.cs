...
namespace EditordeGrafos
{
    public partial class Editor : Form
    {
        ...
        */
        ...
        private void m_pesoAristas_Click(object sender, EventArgs e)
        {

        }

        private void m_nombreAristas_Click(object sender, EventArgs e)
        {

        }

        //Boton Muestra Grados
        private void toolStripButton6_Click(object sender, EventArgs e)
        {
            muestraGrados frm = new muestraGrados(graph);
            frm.ShowDialog();
        }

        //Boton Nodos Especiales
        private void toolStripButton7_Click(object sender, EventArgs e) 
        {
            NodosEspeciales frm = new NodosEspeciales(graph);
            frm.ShowDialog();
        }

        private void menuStripMenuGeneralAtributos_Click(object sender, EventArgs e)
        {
        ...
        {
            MuestraDFS frm = new MuestraDFS(graph);
            frm.ShowDialog();
        }
        ...
        {
            Amplitud frm = new Amplitud(graph);
            frm.ShowDialog();
        }

        //Boton para mostrar componentes conexos de grafos no dirigidos
        private void toolStripButton9_Click(object sender, EventArgs e)
        {
            ConexosNoDirigido frm = new ConexosNoDirigido(graph);
            frm.ShowDialog();
        }

        //Boton para mostrar Euler
        private void btnEuler_Click(object sender, EventArgs e)
        {
            MuestraEuler frm = new MuestraEuler(graph);
            frm.ShowDialog();
        }
        ...
        {
            MuestraDijkstra frm = new MuestraDijkstra(graph);
            frm.ShowDialog();
        }

        private void MapaSkyrim_Click(object sender, EventArgs e)
        {
            Mapa frm = new Mapa();
            frm.ShowDialog();
        }
        ...
        {
            MuestraKruskal frm = new MuestraKruskal(graph);
            frm.ShowDialog();
        }

        private void Prim_Click(object sender, EventArgs e)
        {
            MuestraPrim frm = new MuestraPrim(graph);
            frm.ShowDialog();
        }
