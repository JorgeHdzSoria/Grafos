...
namespace EditordeGrafos {
    ...
    public class Graph : List<NodeP> { //Hereda de una lista tipo NodeP
        ...
        private bool letter;
        private string name;
        public List<Edge> edgesList; //Lista de aristas
        ...
        public void AddNode(NodeP n) { //Agrega nodo
            Add(n);
        }

        public void AddEdge(Edge A) { //Agrega arista
            EdgesList.Add(A);
        }

        public void RemoveEdge(Edge ar) { //Elimina arista
            NodeR rel;
        ...
        public void RemoveNode(NodeP rem) { //Elimina nodo
            NodeR rel;
            List<Edge> remove;
